...
# get theta data
theta_fn = 'assets/vatayana/theta.tsv'
...
# get phi data
phi_fn = 'assets/vatayana/phi.csv'
...
topic_top_words_fn = 'assets/vatayana/topic_top_words.txt'
...
topic_interpretation_fn = 'assets/vatayana/topic_interpretations.txt'
...
doc_original_fulltext = load_dict_from_json("assets/vatayana/doc_original_fulltext.json")
# e.g. doc_original_fulltext[DOC_ID] = STRING

stored_textView_HTML_relative_path = "assets/vatayana/textView_HTML"
